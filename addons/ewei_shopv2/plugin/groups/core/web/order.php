...
class Order_EweiShopV2Page extends PluginWebPage 
{
	...
	public function enabled() 
	{
		...
		foreach ($items as $item ) 
		{
			...
			plog('groups.order.edit', (('修改订单资源<br/>ID: ' . $item['id'] . '<br/>标题: ' . $item['name'] . '<br/>状态: ' . $_GPC['enabled']) == 1 ? '显示' : '隐藏'));
		}
