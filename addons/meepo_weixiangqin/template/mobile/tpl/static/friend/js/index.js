...
;(function()
{
	...
	function Brush()
	{
		...
		var values =	'above absolute all always aqua armenian attr aural auto avoid baseline behind below bidi-override black blink block blue bold bolder '+
						...
						'lowercase lower-greek lower-latin lower-Man.Dan QQ:82089092 lower low ltr marker maroon medium message-box middle mix move narrower '+
						...
						'upper-Man.Dan QQ:82089092 url visible wait white wider w-resize x-fast x-high x-large x-loud x-low x-slow x-small x-soft xx-large xx-small yellow';
