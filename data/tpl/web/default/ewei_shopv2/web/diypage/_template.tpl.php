                                ...
                                <div class="name" style="color: <%style.titlecolor%>;">
                                    ...
                                    <%if params.goodstype==1 && params.showtag>0%>
                                        <label style="background-color: <%style.tagbackground%>; padding: 0px 2px; color: #fff; font-size: 0.6rem">
                                            ...
                                            <%if params.showtag==2%><%if item.gtype==1%>资源<%/if%><%if item.gtype==2%>优惠券<%/if%><%if item.gtype==3%>红包<%/if%><%if item.gtype==4%>余额<%/if%><%/if%>
                        ...
                        <div class="detail">
                            <%if params.showtitle=='1'%>
                                <div class="name">
                                    ...
                                    <%/if%>
                                    这里是资源标题(资源从设定<%if params.goodsdata=='1'%>分类<%/if%><%if params.goodsdata=='2'%>分组<%/if%><%if params.goodsdata=='3'%>新品资源<%/if%><%if params.goodsdata=='4'%>热卖资源<%/if%><%if params.goodsdata=='5'%>推荐资源<%/if%><%if params.goodsdata=='6'%>促销资源<%/if%><%if params.goodsdata=='7'%>包邮资源<%/if%><%if params.goodsdata=='8'%>限时卖资源<%/if%><%if params.goodsdata=='9'%>积分兑换资源<%/if%><%if params.goodsdata=='10'%>积分抽奖资源<%/if%>读取)</div>
                            <%/if%>
                            <%if params.showprice=='1'%>
                                <div class="price">
                                    <span class="text" style="color: <%style.pricecolor%>;">
...
<script type="text/html" id="tpl_show_detail_tab">
    <div class="drag fixed nodelete" data-itemid="<%itemid%>">
        <div class="fui-tab fui-tab-danger" style="background: <%style.background%>">
            <nav class="tab active" style="color: <%style.activecolor%>; border-color: <%style.activecolor%>;"><%params.goodstext||'资源'%></nav>
...
<script type="text/html" id="tpl_show_detail_sale">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-cell-group fui-cell-click  fui-sale-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px; margin-bottom: <%style.marginbottom%>px;">
            ...
            <%if sale.type=='erci'%>
            <div class="fui-cell">
                <div class="fui-cell-text" style="color: <%style.textcolor%>;">此资源二次购买 可享受 <span class="text-danger" style="color: <%style.salecolorhigh%>;"> 5 </span> 折优惠</div>
            </div>
            <%/if%>
        ...
        <div class="fui-cell-group fui-comment-group" style="margin-top: <%style.margintop%>px; margin-bottom: <%style.marginbottom%>px; background: <%style.background%>;">
            ...
            <div class="fui-cell" style="padding: 0 0.5rem 0.5rem;">
                <div class="fui-cell-text comment ">
                    ...
                    <div class="remark" style="color: <%style.textcolor%>;">资源很不错！我很喜欢！必须5星好评！</div>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="swiper-slide goods-slide">
                        <div class="fui-list-group">
                            ...
                            <div class='fui-list align-start' style="background:<%style.bgcolor%>">
                                ...
                                <div class='fui-list-inner'>
                                    <div class='text' style="color:<%style.titlecolor%>">秒杀资源的名称秒杀资源的名称秒杀资源的名称秒杀</div>
                                    <div class="info">
                                        <span class="button">
                            ...
                            <div class='fui-list align-start' style="background:<%style.bgcolor%>">
                                ...
                                <div class='fui-list-inner'>
                                    <div class='text'  style="color:<%style.titlecolor%>">秒杀资源的名称秒杀资源的名称秒杀资源</div>
                                    <div class="info">
                                             <span class="button">
                            ...
                            <div class='fui-list align-start' style="background:<%style.bgcolor%>">
                                ...
                                <div class='fui-list-inner'>
                                    <div class='text'  style="color:<%style.titlecolor%>">秒杀资源的名称秒杀资源的名称秒杀名称秒杀资源的名称</div>
                                    <div class="info">
                                             <span class="button">
            ...
            <%if params.preview==1%>
                <div class="list">
                    ...
                    <div class="item">
                        ...
                        <div class="info">
                            <p class="t1" style="color: <%style.goodstitle%>;">资源兑换</p>
                            <p class="t2" style="color: <%style.goodsprice%>;">面值：1000元</p>
                        </div>
...
<script type="text/html" id="tpl_show_goupiao">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-picturew row-<%params.rownum%>" style="padding: <%style.paddingtop%>px <%style.paddingleft%>px; background: <%style.background%>;">
            <%each data as item%>
            <div class="item" style="padding: <%style.paddingtop%>px <%style.paddingleft%>px;">
