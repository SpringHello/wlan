...
<div class='fui-page  fui-page-current page-goods-list'>
	...
	<div class='fui-content-inner'>
		...
		<i class='icon icon-searchlist'></i><br/>暂时没有任何资源
	    </div>
	...
	<div class="attribute">
	    <div class="item">
		<div class="btn btn-default-o block" data-type="isrecommand"><i class="icon icon-check"></i> 推荐资源</div>
	    </div>
	    <div class="item">
		<div class="btn btn-default-o block" data-type="isnew"><i class="icon icon-check"></i> 新品上市</div>
	    </div>
	    <div class="item">
		<div class="btn btn-default-o block" data-type="ishot"><i class="icon icon-check"></i> 热卖资源</div>
	    </div>
	    <div class="item">
		<div class="btn btn-default-o block" data-type="isdiscount"><i class="icon icon-check"></i> 促销资源</div>
	    </div>
	    <div class="item">
