		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<?php  } ?>
					<a href="<?php  echo mobileUrl('article',array('aid'=>$article['id']), true)?>" target="_blank" data-toggle="tooltip" title="点击预览"><?php  echo $article['article_title'];?></a>
				</td>
				...
				<td>
					...
					<?php  } ?>
					<a href="javascript:;" data-url="<?php  echo mobileUrl('article',array('aid'=>$article['id']), true)?>" class="js-clip btn btn-default btn-sm"><i class='fa fa-link'></i> 复制链接</a> 
					<?php if(cv('article.edit')) { ?>
