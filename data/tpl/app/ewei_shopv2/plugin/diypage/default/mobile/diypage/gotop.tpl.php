<?php defined('IN_IA') or exit('Access Denied');?><a class="diy-gotop external" style="<?php  if(!empty($diygotop['params']['gotoptype'])) { ?>width: <?php  echo $diygotop['style']['width'];?>px;<?php  } ?> position: fixed; overflow: hidden; z-index: 999; <?php  if($diygotop['params']['iconposition']=='left bottom') { ?>bottom: <?php  echo $diygotop['style']['top'];?>px; left: <?php  echo $diygotop['style']['left'];?>px; text-align: left;<?php  } else if($diygotop['params']['iconposition']=='right bottom') { ?>bottom: <?php  echo $diygotop['style']['top'];?>px; right: <?php  echo $diygotop['style']['left'];?>px; text-align: left;<?php  } ?> <?php  if(!empty($diygotop['params']['gotopheight'])) { ?>display:none;<?php  } ?>" <?php  if(!empty($diygotop['params']['gotopclick'])) { ?>href="<?php  echo $diygotop['params']['linkurl'];?>"<?php  } else { ?> id="gotop"<?php  } ?> >
