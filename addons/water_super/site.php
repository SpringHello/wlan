				...
				if ($systeminfo['mbxx'] == 2) {
					...
					if (!empty($systeminfo['utopayordermid'])) {
						...
						if ($systeminfo['iswww'] == "IT") {
							...
							$dataxx['data'] = array('first' => array('value' => '您好，你有如下资源需要付款。', 'color' => '#173177',), 'keyword1' => array('value' => $orderinfo['ordercode'], 'color' => '#173177',), 'keyword2' => array('value' => $systeminfo['fuwuname'], 'color' => '#173177',), 'keyword3' => array('value' => $ordercost . '元', 'color' => '#173177',), 'keyword4' => array('value' => '待付款', 'color' => '#173177',), 'remark' => array('value' => '请及时付款，如有问题，欢迎拨打客服电话：' . $systeminfo['kefutel'], 'color' => '#173177',),);

						} else {

							$dataxx['data'] = array('first' => array('value' => '您好，你有如下资源需要付款。', 'color' => '#173177',), 'keyword1' => array('value' => $systeminfo['fuwuname'], 'color' => '#173177',), 'keyword2' => array('value' => $ordercost . '元', 'color' => '#173177',), 'remark' => array('value' => '请及时付款，如有问题，欢迎拨打客服电话：' . $systeminfo['kefutel'], 'color' => '#173177',),);
		...
		if (checksubmit()) {
			...
			if ($isygdj && intval($isygdj) == 1) {
				...
				if (empty ($ordercost) || $ordercost == '' || floatval($ordercost) < 0) {
					...
					message('抱歉，之前的订单已过期，请重新选择资源再下单', $this->createMobileUrl('index'), 'error');
