...
<html lang="zh-cn">
    <head>
        ...
        <link href="<?php  echo EWEI_SHOPV2_LOCAL?>static/css/elwan.css" rel="stylesheet">
    ...
    <body class="white-bg ">
        <div id='topbar' class='top-navigation   gray-bg '>
            <nav class="navbar   gray-bg " role="navigation">
                <div class="navbar-header" style="width:230px;border-right: 1px solid #e7e7e7;">
                    <button aria-controls="navbar" aria-expanded="false" data-target="#navbar" data-toggle="collapse" class="navbar-toggle collapsed" type="button">
                        <i class="fa fa-reorder"></i>
                    </button>
		    <?php  if(!empty($copyright) && !empty($copyright['logo'])) { ?>
		    <a style='padding:0;overflow:hidden;'><img src="<?php  echo tomedia($copyright['logo'])?>" style='width:150px;height:60px;' /></a>
		    <?php  } else { ?>
		    <a class="navbar-brand" href="<?php  echo webUrl()?>">eWLAN运营平台</a>
		    <?php  } ?>
		</div>