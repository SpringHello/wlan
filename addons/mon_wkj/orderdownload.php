...
$tableheader = array($this->encode("资源"),$this->encode("款式"),$this->encode('用户openID'),$this->encode( "订单编号"),$this->encode( "微信支付单号"),$this->encode("收货人"),$this->encode("电话"),$this->encode("收货地址"),$this->encode("资源原价"),$this->encode("砍后价格"),$this->encode("运费"),$this->encode("支付金额"),$this->encode("状态"),$this->encode("下单时间"),$this->encode("支付时间"));
