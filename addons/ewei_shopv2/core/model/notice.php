...
class Notice_EweiShopV2Model 
{
	...
	public function sendTeamMessage($orderid = '0', $delRefund = false) 
	{
		...
		$datas = array( array('name' => '商城名称', 'value' => $_W['shopset']['shop']['name']), array('name' => '粉丝昵称', 'value' => $member['nickname']), array('name' => '订单号', 'value' => $order['orderno']), array('name' => '订单金额', 'value' => ($order['price'] - $order['creditmoney']) + $order['freight']), array('name' => '运费', 'value' => $order['freight']), array('name' => '资源详情', 'value' => $goods), array('name' => '快递公司', 'value' => $order['expresscom']), array('name' => '快递单号', 'value' => $order['expresssn']), array('name' => '下单时间', 'value' => date('Y-m-d H:i', $order['createtime'])), array('name' => '支付时间', 'value' => date('Y-m-d H:i', $order['paytime'])), array('name' => '发货时间', 'value' => date('Y-m-d H:i', $order['sendtime'])), array('name' => '收货时间', 'value' => date('Y-m-d H:i', $order['finishtime'])) );
		...
		if ($delRefund == true) 
		{
			...
			$msg = array( 'first' => array('value' => '您的订单已经完成退款！', 'color' => '#4a5077'), 'keyword1' => array('title' => '退款金额', 'value' => '¥' . $price . '元', 'color' => '#4a5077'), 'keyword2' => array('title' => '资源详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword3' => array('title' => '订单编号', 'value' => $order['orderno'], 'color' => '#4a5077'), 'remark' => array('value' => '退款金额 ¥' . $price . $refundtype . "\r\n" . ' 【' . $shop['name'] . '】期待您再次购物！', 'color' => '#4a5077') );
		...
		if ($order['status'] == 1) 
		{
			if ($order['success'] == 1) 
			{
				...
				{
					$msg = array( 'first' => array('value' => '您参加的拼团已经成功组团！', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单号', 'value' => $value['orderno'], 'color' => '#4a5077'), 'keyword2' => array('title' => '时间', 'value' => date('Y-m-d H:i', $value['paytime']), 'color' => '#4a5077'), 'keyword3' => array('title' => '资源', 'value' => $order_goods['title'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				...
				$msgteam = array( 'first' => array('value' => '拼团已经成功组团！', 'color' => '#4a5077'), 'keyword1' => array('title' => '资源信息', 'value' => $goods, 'color' => '#4a5077'), 'keyword2' => array('title' => '付款金额', 'value' => $orderpricestr, 'color' => '#4a5077'), 'keyword3' => array('title' => '预计发货时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#4a5077'), 'remark' => array('value' => $remarkteam, 'color' => '#4a5077') );
			...
			if ($order['success'] == -1) 
			{
				...
				$msg = array( 'first' => array('value' => '您参加的拼团组团失败！', 'color' => '#4a5077'), 'keyword1' => array('title' => '店铺', 'value' => $shop['name'], 'color' => '#4a5077'), 'keyword2' => array('title' => '通知时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#4a5077'), 'keyword3' => array('title' => '资源', 'value' => $order_goods['title'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				foreach ($order as $key => $value ) 
				{
			...
			if ($order['success'] == 0) 
			{
				...
				$msg = array( 'first' => array('value' => '您的订单已提交成功！', 'color' => '#4a5077'), 'keyword1' => array('title' => '店铺', 'value' => $shop['name'], 'color' => '#4a5077'), 'keyword2' => array('title' => '下单时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#4a5077'), 'keyword3' => array('title' => '资源', 'value' => $goods, 'color' => '#4a5077'), 'keyword4' => array('title' => '金额', 'value' => $orderpricestr, 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				$this->sendGroupsNotice(array('openid' => $openid, 'tag' => 'groups_pay', 'default' => $msg, 'url' => $url, 'datas' => $datas));
				if (!($order['is_team'])) 
				{
					$tm = m('common')->getSysset('notice');
					$remarkteam = '单购订单成功了，准备发货';
					$msgteam = array( 'first' => array('value' => '单购订单成功了！', 'color' => '#4a5077'), 'keyword1' => array('title' => '资源信息', 'value' => $goods, 'color' => '#4a5077'), 'keyword2' => array('title' => '付款金额', 'value' => $orderpricestr, 'color' => '#4a5077'), 'keyword3' => array('title' => '预计发货时间', 'value' => date('Y-m-d H:i:s', time()), 'color' => '#4a5077'), 'remark' => array('value' => $remarkteam, 'color' => '#4a5077') );
					$business = explode(',', $tm['openid']);
					foreach ($business as $value ) 
					{
						$this->sendGroupsNotice(array('openid' => $value, 'tag' => 'groups_teamsend', 'default' => $msgteam, 'datas' => $datas));
	...
	public function sendOrderMessage($orderid = '0', $delRefund = false) 
	{
		...
		if ($delRefund) 
		{
			...
			if (!(empty($order['refundid']))) 
			{
				...
				if (empty($refund['status'])) 
				{
					...
					$msg = array( 'first' => array('value' => '您的' . $r_type[$refund['rtype']] . '申请已经提交！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => ($refund['rtype'] == 3 ? '-' : '¥' . $refund['applyprice'] . '元'), 'color' => '#4a5077'), 'orderProductName' => array('title' => '资源详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '等待商家确认' . $r_type[$refund['rtype']] . '信息！', 'color' => '#4a5077') );
				...
				if ($refund['status'] == 3) 
				{
					...
					$msg = array( 'first' => array('value' => '您的' . $r_type[$refund['rtype']] . '申请已经通过！', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'keyword2' => array('title' => '当前进度', 'value' => '您的' . $r_type[$refund['rtype']] . '申请已经通过！', 'color' => '#4a5077'), 'keyword3' => array('title' => '资源名称', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword4' => array('title' => '退款金额', 'value' => ($refund['rtype'] == 3 ? '-' : '¥' . $refund['applyprice'] . '元'), 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '请您根据商家提供的退货地址将资源寄回！' . $refund_address . '', 'color' => '#4a5077') );
				...
				if ($refund['status'] == 5) 
				{
					...
					$msg = array( 'first' => array('value' => '您的换货物品已经发货！', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'keyword2' => array('title' => '当前进度', 'value' => '您的换货物品已经发货！快递公司: ' . $refund['rexpresscom'] . ' 快递单号: ' . $refund['rexpresssn'], 'color' => '#4a5077'), 'keyword3' => array('title' => '资源名称', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword4' => array('title' => '退款金额', 'value' => ($refund['rtype'] == 3 ? '-' : '¥' . $refund['applyprice'] . '元'), 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '我们正加速送到您的手上，请您耐心等候。', 'color' => '#4a5077') );
					$this->sendNotice(array('openid' => $openid, 'tag' => 'refunding', 'default' => $msg, 'url' => $url, 'datas' => $datas));
					com_run('sms::callsms', array('tag' => 'refunding', 'datas' => $datas, 'mobile' => $member['mobile']));
					return;
				}
				if ($refund['status'] == 1) 
				{
					...
					if ($refund['rtype'] == 2) 
					{
						$msg = array( 'first' => array('value' => '您的订单已经完成换货！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => '-', 'color' => '#4a5077'), 'orderProductName' => array('title' => '资源详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . ' 换货成功！【' . $shop['name'] . '】期待您再次购物！', 'color' => '#4a5077') );
					}
					else 
					{
						$refundtype = '';
						...
						$msg = array( 'first' => array('value' => '您的订单已经完成退款！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => '¥' . $refund['price'] . '元', 'color' => '#4a5077'), 'orderProductName' => array('title' => '资源详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . ' 退款金额 ¥' . $refund['price'] . $refundtype . "\r\n" . ' 【' . $shop['name'] . '】期待您再次购物！', 'color' => '#4a5077') );
					}
				...
				if ($refund['status'] == -1) 
				{
					...
					$msg = array( 'first' => array('value' => '您的' . $r_type[$refund['rtype']] . '申请被商家驳回，可与商家协商沟通！', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '退款金额', 'value' => '¥' . $refund['price'] . '元', 'color' => '#4a5077'), 'orderProductName' => array('title' => '资源详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'orderName' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
		...
		if ($order['status'] == -1) 
		{
			...
			$msg = array( 'first' => array('value' => '您的订单已取消!', 'color' => '#4a5077'), 'orderProductPrice' => array('title' => '订单金额', 'value' => '¥' . $order['price'] . '元(含运费' . $order['dispatchprice'] . '元)', 'color' => '#4a5077'), 'orderProductName' => array('title' => '资源详情', 'value' => $goods, 'color' => '#4a5077'), 'orderAddress' => $orderAddress, 'orderName' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '【' . $shop['name'] . '】欢迎您的再次购物！', 'color' => '#4a5077') );
		...
		if ($order['status'] == 0) 
		{
			...
			if (is_array($newtype) && in_array('0', $newtype)) 
			{
				...
				$msg = array( 'first' => array('value' => '订单下单通知!', 'color' => '#4a5077'), 'keyword1' => array('title' => '时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#4a5077'), 'keyword2' => array('title' => '资源名称', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword3' => array('title' => '订单号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
			...
			foreach ($order_goods as $og ) 
			{
				if (!(empty($og['noticeopenid']))) 
				{
					...
					if (empty($og['noticetype']) || (is_array($noticetype) && in_array('0', $noticetype))) 
					{
						...
						$msg = array( 'first' => array('value' => '资源下单通知!', 'color' => '#4a5077'), 'keyword1' => array('title' => '时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#4a5077'), 'keyword2' => array('title' => '资源名称', 'value' => $goodstr, 'color' => '#4a5077'), 'keyword3' => array('title' => '订单号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
			...
			if (empty($usernotice['submit'])) 
			{
				...
				$msg = array( 'first' => array('value' => '您的订单已提交成功！', 'color' => '#4a5077'), 'keyword1' => array('title' => '店铺', 'value' => $shop['name'], 'color' => '#4a5077'), 'keyword2' => array('title' => '下单时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#4a5077'), 'keyword3' => array('title' => '资源', 'value' => $goods, 'color' => '#4a5077'), 'keyword4' => array('title' => '金额', 'value' => '¥' . $order['price'] . '元(含运费' . $order['dispatchprice'] . '元)', 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
		...
		else if ($order['status'] == 1) 
		{
			...
			if (is_array($newtype) && in_array('1', $newtype)) 
			{
				...
				$msg = array( 'first' => array('value' => '订单下单支付通知!', 'color' => '#4a5077'), 'keyword1' => array('title' => '时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#4a5077'), 'keyword2' => array('title' => '资源名称', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword3' => array('title' => '订单号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				$account = m('common')->getAccount();
				if (!(empty($tm['openid']))) 
				{
					$openids = explode(',', $tm['openid']);
			...
			foreach ($order_goods as $og ) 
			{
				...
				if (($og['noticetype'] == '1') || (is_array($noticetype) && in_array('1', $noticetype))) 
				{
					...
					$msg = array( 'first' => array('value' => '资源下单支付通知!', 'color' => '#4a5077'), 'keyword1' => array('title' => '时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#4a5077'), 'keyword2' => array('title' => '资源名称', 'value' => $goodstr, 'color' => '#4a5077'), 'keyword3' => array('title' => '订单号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
					$datas[] = array('name' => '单品详情', 'value' => $goodstr);
			...
			if (empty($order['isverify'])) 
			{
				...
				$msg = array( 'first' => array('value' => '自提订单提交成功!', 'color' => '#4a5077'), 'keyword1' => array('title' => '自提码', 'value' => $order['verifycode'], 'color' => '#4a5077'), 'keyword2' => array('title' => '资源详情', 'value' => $goods . $orderpricestr, 'color' => '#4a5077'), 'keyword3' => array('title' => '提货地址', 'value' => $store['address'], 'color' => '#4a5077'), 'keyword4' => array('title' => '提货时间', 'value' => $store['saletime'], 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '请您到选择的自提点进行取货, 自提联系人: ' . $store['realname'] . ' 联系电话: ' . $store['mobile'], 'color' => '#4a5077') );
			...
			if ($pv && !(empty($order['virtual']))) 
			{
				...
				foreach ($order_goods as $og ) 
				{
					...
					if (($og['noticetype'] == '2') || (is_array($noticetype) && in_array('2', $noticetype))) 
					{
						...
						$goodstr .= ' 单价: ' . ($og['price'] / $og['total']) . ' 数量: ' . $og['total'] . ' 总价: ' . $og['price'] . '); ';
						$msg = array( 'first' => array('value' => $first, 'color' => '#4a5077'), 'keyword1' => array('title' => '订单号', 'value' => $order['ordersn'], 'color' => '#4a5077'), 'keyword2' => array('title' => '资源名称', 'value' => $goodstr, 'color' => '#4a5077'), 'keyword3' => array('title' => '下单时间', 'value' => date('Y-m-d H:i:s', $order['createtime']), 'color' => '#4a5077'), 'keyword4' => array('title' => '发货时间', 'value' => date('Y-m-d H:i:s', $order['sendtime']), 'color' => '#4a5077'), 'keyword5' => array('title' => '确认收货时间', 'value' => date('Y-m-d H:i:s', $order['finishtime']), 'color' => '#4a5077'), 'remark' => array('title' => '', 'value' => $remark, 'color' => '#4a5077') );
						$datas[] = array('name' => '单品详情', 'value' => $goodstr);
