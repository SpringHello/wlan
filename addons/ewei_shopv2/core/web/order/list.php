	...
	protected function orderData($status, $st) 
	{
		...
		if ($_GPC['export'] == 1) 
		{
			...
			if ($ccard_plugin) 
			{
				...
				{
					$field = 'goods_' . $key;
					$columns[] = array('title' => $value . '(资源自定义信息)', 'field' => $field, 'width' => 24);
				}
