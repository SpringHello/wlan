...
class DiypageModel extends PluginModel 
{
	...
	{
		$pagetype = array( 1 => array('name' => '自定义', 'pagetype' => 'diy', 'class' => ''), 2 => array('name' => '商城首页', 'pagetype' => 'sys', 'class' => 'success'), 3 => array('name' => '会员中心', 'pagetype' => 'sys', 'class' => 'primary'), 4 => array('name' => '分销中心', 'pagetype' => 'plu', 'class' => 'warning'), 5 => array('name' => '资源详情页', 'pagetype' => 'sys', 'class' => 'danger'), 6 => array('name' => '积分商城', 'pagetype' => 'plu', 'class' => 'info'), 7 => array('name' => '整点秒杀', 'pagetype' => 'plu', 'class' => 'danger'), 8 => array('name' => '兑换中心', 'pagetype' => 'plu', 'class' => 'success'), 99 => array('name' => '公用模块', 'pagetype' => 'mod', 'class' => '') );
		if (!(empty($type))) 
		{
