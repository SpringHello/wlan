		...
		public function sendMessage($id = 0) 
		{
			...
			if ($log['status'] == 2) 
			{
				...
				else if ($log['dispatchstatus'] != 1) 
				{
					...
					$msg = array( 'first' => array('value' => '恭喜您，资源兑换成功~', 'color' => '#4a5077'), 'keyword1' => array('title' => '奖品名称', 'value' => $goods['title'], 'color' => '#4a5077'), 'keyword2' => array('title' => '消耗积分', 'value' => $credits, 'color' => '#4a5077'), 'keyword3' => array('title' => '兑换时间', 'value' => date('Y-m-d', time()), 'color' => '#4a5077'), 'keyword4' => array('title' => '剩余积分', 'value' => $credit, 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				...
				if (($log['dispatchstatus'] == 1) || ($log['dispatchstatus'] == -1)) 
				{
					...
					$msg = array( 'first' => array('value' => '积分商城资源兑换成功~', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单编号', 'value' => $log['logno'], 'color' => '#4a5077'), 'keyword2' => array('title' => '资源名称', 'value' => $goods['title'], 'color' => '#4a5077'), 'keyword3' => array('title' => '兑换时间', 'value' => date('Y-m-d', $log['createtime']), 'color' => '#4a5077'), 'keyword4' => array('title' => '兑换码', 'value' => ($goods['isverify'] ? '已发放' : '物流配送'), 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
			...
			else if ($log['status'] == 3) 
			{
				...
				$msg = array( 'first' => array('value' => '您的积分兑换奖品已发货~', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单金额', 'value' => '使用 ' . $credits, 'color' => '#4a5077'), 'keyword2' => array('title' => '资源详情', 'value' => $goods['title'], 'color' => '#4a5077'), 'keyword3' => array('title' => '收货信息', 'value' => $info, 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				if (!(empty($tm['send']))) 
				{
				...
				$msg_saler = array( 'first' => array('value' => '用户奖品兑换成功~', 'color' => '#4a5077'), 'keyword1' => array('title' => '订单金额', 'value' => '使用 ' . $credits, 'color' => '#4a5077'), 'keyword2' => array('title' => '资源详情', 'value' => $goods['title'], 'color' => '#4a5077'), 'keyword3' => array('title' => '收货信息', 'value' => $info, 'color' => '#4a5077'), 'remark' => array('value' => $remark, 'color' => '#4a5077') );
				if (!(empty($tm['send']))) 
				{
