...
class Export_EweiShopV2Page extends MerchWebPage 
{
	...
	public function main() 
	{
		...
		if ($_GPC['export'] == 1) 
		{
			...
			if ($goodsindex != -1) 
			{
				array_splice($columns, $goodsindex + 1, 0, array( array('title' => '资源编码', 'field' => 'goods_goodssn', 'width' => 12), array('title' => '资源规格', 'field' => 'goods_optiontitle', 'width' => 12), array('title' => '资源数量', 'field' => 'goods_total', 'width' => 12), array('title' => '资源单价(折扣前)', 'field' => 'goods_price1', 'width' => 12), array('title' => '资源单价(折扣后)', 'field' => 'goods_price2', 'width' => 12), array('title' => '资源价格(折扣后)', 'field' => 'goods_rprice1', 'width' => 12), array('title' => '资源价格(折扣后)', 'field' => 'goods_rprice2', 'width' => 12) ));
			}
