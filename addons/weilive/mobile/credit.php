<?php
	...
	if (!empty($_GPC['award_id']))
	{
		...
		{
			message('积分不足或资源已经兑空，请重新选择资源！<br>当前资源所需积分:'.$award_info['credit_cost'].'<br>您的积分:'.$fans['credit1']
				. '. 资源剩余数量:' . $award_info['amount']
	...
	{
		message('请选择要兑换的资源！', create_url('mobile/module/award', array('weid' => $weid, 'name' => 'hcweilive')), 'error');
	}
?>