...
<div class='fui-page fui-page-current  page-goods-detail' id='page-goods-detail-index'>
    ...
    <div class="fui-header">
        ...
        <div class="title">
            <div id="tab" class="fui-tab fui-tab-danger">
                <a data-tab="tab1" class="tab active">资源</a>
    ...
    <div class="fui-content param-block  <?php  if(!$goods['canbuy']) { ?>notbuy<?php  } ?>">
        <div class="fui-cell-group">
            ...
            <?php  } else { ?>
            <div class="fui-cell">
                <div class="fui-cell-info text-align">资源没有参数</div>
            </div>
            <?php  } ?>
        </div>
    </div>
...
<div class="fui-content detail-block  <?php  if(!$goods['canbuy']) { ?>notbuy<?php  } ?>">
    <div class="text-danger look-basic"><i class='icon icon-unfold'></i> <span>上拉返回资源详情</span></div>
...
<div class="fui-cell-group  fui-sale-group" style="margin-top:0">
    <div class="fui-cell">
        <div class="fui-cell-text" style="white-space: normal;">此资源二次购买 可享受 <span class="text-danger"><?php  echo $goods['buyagain'];?></span> 折优惠
...
<div class="fui-cell-group fui-shop-group">
    ...
    <div class="fui-cell btns">
        <div class="fui-cell-text center">
            <a class="btn btn-default-o external" href="<?php  echo $shopdetail['btnurl1'];?>"><?php  if(!empty($shopdetail['btntext1'])) { ?><?php  echo $shopdetail['btntext1'];?><?php  } else { ?>全部资源<?php  } ?></a>
...
<div class='fui-content'>
    <div class='content-empty'>
        <i class='icon icon-searchlist'></i><br/> 资源已经下架，或者已经删除!<br/><a href="<?php  echo mobileUrl()?>" class='btn btn-default-o external'>到处逛逛</a>
    </div>
</div>
<?php  } ?>
