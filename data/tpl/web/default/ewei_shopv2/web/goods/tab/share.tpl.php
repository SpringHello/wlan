...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <?php if( ce('goods' ,$item) ) { ?>
           ...
           <span  class='help-block'>购买资源必须关注，如果未关注，弹出的提示，如果为空默认为“如果您想要购买此资源，需要您关注我们的公众号，点击【确定】关注后再来购买吧~”</span>
           <?php  } else { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <?php if( ce('goods' ,$item) ) { ?>
           ...
           <span  class='help-block'>购买资源必须关注，如果未关注，跳转的链接，如果为空默认为系统关注页</span>
           <?php  } else { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <span class='help-block'>如果不填写，默认为资源名称</span>
        <?php  } else { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <span class='help-block'>如果不选择，默认为资源缩略图片</span>
             <?php  } else { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <span class='help-block'>如果不填写，则使用资源副标题，如资源副标题为空则使用店铺名称</span>
             <?php  } else { ?>
