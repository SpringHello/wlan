...
<div class="navbar-collapse collapse" id="navbar">
	...
	<ul class="nav navbar-nav gray-bg elwan-nav-bg"   style="position:absolute;left: 0px; top:60px;width:230px; text-align:center;">

       <div   style="width:229px;text-align: left;"><a  style="border-bottom:1px solid #efefef;color:#333;padding: 15px 15px;width:230px;display: block;">应用快捷进入</a></div></br>


	  <li  <?php  if($_W['controller']=='shop00') { ?> class="active"<?php  } ?>   style="margin-top:-18px;"     ><a   href="<?php  echo webUrl(commission)?>"><i class="fa fa-users"></i>分销设置</a></li></br>
    ...
    <ul class="nav navbar-top-links navbar-right">
        <li class="dropdown">
            <a aria-expanded="false" role="button" href="#" class="dropdown-toggle" data-toggle="dropdown" style="position:relative;" onclick="$(this).find('span').toggleClass('deg180')">
                ...
                <span class="caret" style="position: absolute;top: 28px;right: 12px;"></span></a>
