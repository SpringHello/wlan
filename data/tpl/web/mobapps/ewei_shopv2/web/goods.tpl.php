...
<div class="page-heading"> 
    <span class='pull-right'>
        <?php if(cv('goods.add')) { ?>
        <a class='btn btn-primary btn-sm' href="<?php  echo webUrl('goods/add')?>"><i class='fa fa-plus'></i> 添加资源</a>
        <?php  } ?>
    </span>
    <h2>资源管理</h2> </div>
        ...
        <tr>
            ...
            <td  style="overflow:visible;">
                ...
                <td  style="overflow:visible;position:relative">
                        ...
                        <?php  } ?>
                        <?php if(cv('goods.delete1')) { ?>
                        <a  class='btn btn-default btn-sm' data-toggle='ajaxRemove' href="<?php  echo webUrl('goods/delete1', array('id' => $item['id']))?>" data-confirm='如果此资源存在购买记录，会无法关联到资源, 确认要彻底删除吗?？'><i class='fa fa-remove'></i> </a>
                        <?php  } ?>
                        <?php  } else { ?>
                        <?php if(cv('goods.delete')) { ?>
                        <a  class='btn btn-default btn-sm' data-toggle='ajaxRemove' href="<?php  echo webUrl('goods/delete', array('id' => $item['id']))?>" data-confirm='确认删除此资源？'><i class='fa fa-trash'></i> </a>
                        <?php  } ?>
                        <?php  } ?>
