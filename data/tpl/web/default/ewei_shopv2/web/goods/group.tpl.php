...
<div class="page-heading"> <h2>资源组管理 <small>总数: 12</small></h2></div>

<div class="alert alert-info">资源组现主要用于PortalONE调用</div>
...
<form action method="post">
    <div class="page-toolbar row m-b-sm m-t-sm">
        ...
        <div class="col-sm-6 pull-right">
            <div class="input-group">
                <input type="text" class="input-sm form-control" name="keyword" value="<?php  echo $_GPC['keyword'];?>" placeholder="请输入资源组名称进行搜索">
    ...
    <div class="panel panel-default">
        <div class="panel-body" style="text-align: center;padding:30px;">
            未查询到<?php  if(!empty($_GPC['keyword'])) { ?>"<?php  echo $_GPC['keyword'];?>"<?php  } ?>相关资源组!
        </div>
    </div>
    <?php  } else { ?>
