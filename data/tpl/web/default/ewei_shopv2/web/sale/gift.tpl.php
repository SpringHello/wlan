    ...
    <div class="page-toolbar row m-b-sm m-t-sm">
        <div class="col-sm-6">
            ...
            <div class="input-group-btn">
                ...
                <button class="btn btn-default btn-sm" type="button" data-toggle='batch-remove' data-confirm="如果资源存在购买记录，会无法关联到资源, 确认要彻底删除吗?" data-href="<?php  echo webUrl('sale/gift/delete1')?>">
