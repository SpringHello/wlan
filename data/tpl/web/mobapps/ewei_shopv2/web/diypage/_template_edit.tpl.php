...
<script type="text/html" id="tpl_edit_search">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <label class="radio-inline"><input type="radio" name="goodstype" value="0" class="diy-bind" data-bind-child="params" data-bind="goodstype" <%if params.goodstype=='0'||!params.goodstype%>checked="checked"<%/if%>> 商城资源</label>
            <label class="radio-inline"><input type="radio" name="goodstype" value="1" class="diy-bind" data-bind-child="params" data-bind="goodstype" <%if params.goodstype=='1'%>checked="checked"<%/if%> > 积分商城资源</label>
        </div>
    </div>
...
<script type="text/html" id="tpl_edit_goods">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <label class="radio-inline"><input type="radio" name="goodstype" value="0" class="diy-bind" data-bind-child="params" data-bind="goodstype" data-bind-init="true" <%if params.goodstype=='0'||!params.goodstype%>checked="checked"<%/if%>> 商城资源</label>
            <%if (merch==0||!merch)&&plugins.creditshop==1%>
            <label class="radio-inline"><input type="radio" name="goodstype" value="1" class="diy-bind" data-bind-child="params" data-bind="goodstype" data-bind-init="true" <%if params.goodstype=='1'%>checked="checked"<%/if%> > 积分商城资源</label>
            <%/if%>
            <div class="help-block text-danger">注意：选择好资源类型后尽量不要更改</div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <%if style.liststyle=='block three' && params.goodstype!=1%>
                <div class="help-block text-danger">提示："三列显示资源"显示资源原价及销量可能会造成样式错乱</div>
            <%/if%>
        </div>
    </div>
    ...
    <%if params.goodstype==1%>
        <div class="form-group">
            <div class="col-sm-2 control-label">资源标签</div>
            <div class="col-sm-10">
                ...
                <label class="radio-inline"><input type="radio" name="showtag" value="2" class="diy-bind" data-bind-child="params" data-bind="showtag" data-bind-init="true" <%if params.showtag=='2'%>checked="checked"<%/if%> > 资源类型</label>
                ...
                <div class="help-block">资源类型: 资源、优惠券、红包、余额 活动类型: 兑换、抽奖</div>
            </div>
        </div>
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">资源价格</div>
        <div class="col-sm-10">
    ...
    <%if params.showprice=='1'%>
        ...
        <%if params.goodstype=='0'||!params.goodstype%>
            <div class="form-group">
                <div class="col-sm-2 control-label">资源原价</div>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <div class="col-sm-2 control-label">资源销量</div>
                <div class="col-sm-10">
    ...
    <%if ((params.goodstype=='0'||!params.goodstype) && params.showprice=='1' && style.buystyle!='') || (params.goodstype=='1') && params.showprice=='1'%>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <?php  if(p('bargain')) { ?>
                <span class="help-block">砍价资源不支持自定义按钮样式，仅支持自定义按钮颜色</span>
                <?php  } ?>
            </div>
        </div>
    <%/if%>
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">资源图标</div>
        <div class="col-sm-10">
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">选择资源</div>
        <div class="col-sm-10">
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">选择资源<br>(资源类型)</div>
        <div class="col-sm-10">
            <%if params.goodstype=='0'||!params.goodstype%>
            <label class="radio-inline"><input type="radio" name="goodsdata" value="3" class="diy-bind" data-bind-child="params" data-bind="goodsdata" data-bind-init="true" <%if params.goodsdata=='3'%>checked="checked"<%/if%> > 新品资源</label>
            <label class="radio-inline"><input type="radio" name="goodsdata" value="4" class="diy-bind" data-bind-child="params" data-bind="goodsdata" data-bind-init="true" <%if params.goodsdata=='4'%>checked="checked"<%/if%> > 热卖资源</label>
            <label class="radio-inline"><input type="radio" name="goodsdata" value="6" class="diy-bind" data-bind-child="params" data-bind="goodsdata" data-bind-init="true" <%if params.goodsdata=='6'%>checked="checked"<%/if%> > 促销资源</label>
            <label class="radio-inline"><input type="radio" name="goodsdata" value="7" class="diy-bind" data-bind-child="params" data-bind="goodsdata" data-bind-init="true" <%if params.goodsdata=='7'%>checked="checked"<%/if%> > 包邮资源</label>
            <label class="radio-inline"><input type="radio" name="goodsdata" value="8" class="diy-bind" data-bind-child="params" data-bind="goodsdata" data-bind-init="true" <%if params.goodsdata=='8'%>checked="checked"<%/if%> > 限时卖资源</label>
            <%/if%>
            <label class="radio-inline"><input type="radio" name="goodsdata" value="5" class="diy-bind" data-bind-child="params" data-bind="goodsdata" data-bind-init="true" <%if params.goodsdata=='5'%>checked="checked"<%/if%> > 推荐资源</label>

            <%if params.goodstype==1%>
                <label class="radio-inline"><input type="radio" name="goodsdata" value="9" class="diy-bind" data-bind-child="params" data-bind="goodsdata" data-bind-init="true" <%if params.goodsdata=='9'%>checked="checked"<%/if%> > 积分兑换资源</label>
                <label class="radio-inline"><input type="radio" name="goodsdata" value="10" class="diy-bind" data-bind-child="params" data-bind="goodsdata" data-bind-init="true" <%if params.goodsdata=='10'%>checked="checked"<%/if%> > 积分抽奖资源</label>
            <%/if%>
        </div>
    </div>
        ...
        <div class="form-items indent" data-min="1">
            <div class="inner" id="form-items">
                ...
                <div class="item" data-id="<%itemid%>">
                    <span class="btn-del" title="删除"></span>
                    <div class="item-image square">
                        <div class="text goods-selector" data-goodstype="<%params.goodstype%>">选择资源</div>
    ...
    <%if params.goodsdata>0%>
    <div class="form-group">
        <div class="col-sm-2 control-label">资源排序</div>
        <div class="col-sm-10">
...
<script type="text/html" id="tpl_edit_detail_tab">
    ...
    <div class="line"></div>
    <div class="form-group">
        <div class="col-sm-2 control-label">资源文字</div>
        <div class="col-sm-4">
            <input class="form-control input-sm diy-bind" data-bind-child="params" data-bind="goodstext" value="<%params.goodstext%>" data-placeholder="资源" maxlength="4" />
        </div>
    </div>
    <div class="form-group">
...
<script type="text/html" id="tpl_edit_detail_sale">
    ...
    <div class="form-items indent">
        <div class="inner" id="form-items">
            ...
            <div class="item" data-id="<%itemid%>" style="cursor: move">
                <div class="item-form">
                    <%if child.type=='erci'%>
                    <span style="color: <%style.salecolor%>;">此资源二次购买 可享受<span class="text-danger" style="color: <%style.salecolorhigh%>;"> 5 </span>折优惠</span>
                    <%/if%>
    ...
    <div class="alert alert-danger" style="margin: 0 10px;">注意：此处仅对营销信息显示进行排序，营销信息、标签样式请到资源中设置(以上元素拖动可排序)</div>
</script>
...
<script type="text/html" id="tpl_edit_detail_shop">
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">资源数量</div>
        <div class="col-sm-4">
    ...
    <div class="alert alert-danger" style="margin: 10px 10px 0;">提示：信息读取商城、资源设置</div>
...
<script type="text/html" id="tpl_edit_detail_navbar">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <div class="help-block">提示：此设置仅针对于可加入购物车的资源</div>
        </div>
    </div>
...
<script type="text/html" id="tpl_edit_detail_buyshow">
    ...
    <div class="alert alert-info" style="margin-bottom: 0;">提示：这里是购买可见区域，购买可见内容请到资源中设置</div>
</script>
...
<script type="text/html" id="tpl_edit_seckillgroup">
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">资源原价颜色</div>
        <div class="col-sm-4">
            <div class="input-group input-group-sm">
                <input class="form-control input-sm diy-bind color" data-bind-child="style" data-bind="marketpricecolor" value="<%style.marketpricecolor%>" type="color" />
                <span class="input-group-addon btn btn-default" onclick="$(this).prev().val('#ef4f4f').trigger('propertychange')">重置</span>
    ...
    <div class="form-group">
        <div class="col-sm-2 control-label">资源现价颜色</div>
        <div class="col-sm-4">
            <div class="input-group input-group-sm">
                <input class="form-control input-sm diy-bind color" data-bind-child="style" data-bind="productpricecolor" value="<%style.productpricecolor%>" type="color" />
                <span class="input-group-addon btn btn-default" onclick="$(this).prev().val('#999999').trigger('propertychange')">重置</span>
...
<script type="text/html" id="tpl_edit_goupiao">
    <div class="form-group">
        <div class="col-sm-2 control-label">背景颜色</div>
        <div class="col-sm-4">
            <div class="input-group input-group-sm">
...
<script type="text/html" id="tpl_edit_exchange_input">
    ...
    <%if params.preview=='1'%>
        ...
        <div class="line"></div>
        <div class="form-group">
            <div class="col-sm-2 control-label">资源样式</div>
            <div class="col-sm-10">
                <div class="input-group input-group-sm">
