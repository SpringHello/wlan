    ...
    <form action="" method="post" class="form-horizontal  form-validate" enctype="multipart/form-data" >
      <div class='form-group-title'>关注设置</div>
            ...
            <div class='form-group-title'>分享设置</div>
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">资源详情分享</label>
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">资源详情页面按钮</span>
                        <?php  } else { ?>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">资源详情分享文字</label>
                    <div class="col-sm-9 col-xs-12">
                        <?php if(cv('sysset.follow.edit')) { ?>
                        ...
                        <span class="help-block">资源详情页面按钮 按下 弹出文字 默认文字: <br/><span class="text-danger">请点击右上角<br/>通过【发送给朋友】<br/>邀请好友购买</span></span>
                        <?php  } else { ?>
