    ...
    <div class="page-toolbar row m-b-sm m-t-sm">
        ...
        <div class="col-sm-5 pull-right">
            ...
            <select name='searchfield'  class='form-control  input-sm select-md'   style="width:95px;padding:0 5px;"  >
                ...
                <option value='goodstitle' <?php  if($_GPC['searchfield']=='goodstitle') { ?>selected<?php  } ?>>资源名称</option>
                <option value='goodssn' <?php  if($_GPC['searchfield']=='goodssn') { ?>selected<?php  } ?>>资源编码</option>
...
<table class='table table-responsive' style='table-layout: fixed;'>
    <tr style='background:#f8f8f8'>
        <td style='width:60px;border-left:1px solid #f2f2f2;'>资源</td>
    ...
    <tr class='trbody'>
        ...
        <td  rowspan="<?php  echo count($item['goods'])?>" style='text-align:center' >
            ￥<?php  echo number_format($item['price'],2)?> <a data-toggle='popover' data-html='true' data-placement='top'
                ...
                <tr>
                    <td  style='border:none;text-align:right;'>资源小计：</td>
