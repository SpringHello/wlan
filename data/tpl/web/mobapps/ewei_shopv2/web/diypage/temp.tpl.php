	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			...
			<?php  if($_W['plugin']!='merch'&&empty($_W['merchid'])) { ?>
				...
				<?php  } ?>
				<a class="btn btn-xs <?php  if($_GPC['type']==5) { ?>btn-info<?php  } else { ?>btn-default<?php  } ?>" href="<?php  echo webUrl('diypage/temp', array('type'=>5, 'cate'=>$_GPC['cate'], 'keyword'=>$_GPC['keyword']))?>">资源详情</a>
				<?php  if(p('creditshop')) { ?>
