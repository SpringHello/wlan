...
<!--
<link href="./resource/wshcms/css/style.css" rel="stylesheet"/>
<script src="./resource/wshcms/js/require.js"></script>
<script src="./resource/wshcms/js/app/config.js"></script>
<script src="./resource/wshcms/js/jqbase.js"></script>
-->
...
<!--[if lte IE 6]>
<script type="text/javascript" src="resource/wshcms/js/dd_belatedpng_0.0.7a.js"></script>
<script type="text/javascript">
	DD_belatedPNG.fix('*');
</script>
<![endif]-->
<!--[if IE]>
<script src="resource/wshcms/js/label.js" type="text/javascript" language="javascript"></script>
<![endif]-->
</head>
<body>
<header id="h_reg">
    	...
    	<section class="login_tab">
            ...
            <form action="" method="post" role="form" onsubmit="return formcheck();">
            	<table width="100%">
                    ...
                    <tr>
                    	<td><input  type="submit" name="submit"  class="btn" value="登&nbsp;录" /><input name="token" value="<?php  echo $_W['token'];?>" type="hidden" /></td>
                    </tr>
                    <tr>
                    	<td>
                        	<a href="./index.php?c=user&a=register&" class="reg_a">立即注册</a>
                            <a href="javascript:;" class="getpwd">忘记密码？</a>
                        </td>
                    </tr>
                </table>
            </form>
