...
class CashierModel extends PluginModel 
{
	...
	{
		$perm = array('index' => '我要收款', 'goods' => '资源收款', 'order' => '收款订单', 'statistics' => '收银统计', 'sysset' => '设置', 'sale' => '营销', 'clearing' => '提现', 'goodsmanage' => '资源管理');
	...
	public function goodsCalculate($selfgoods = array(), $shopgoods = array(), $params, $return = false) 
	{
		...
		return array('res' => error('-101', '支付金额与资源金额有误差!'));
	}
