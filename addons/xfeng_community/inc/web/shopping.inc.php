...
defined('IN_IA') or exit('Access Denied');
	...
	if($op == 'nav'){
		...
		if ($operation == 'post') {
			...
			if (empty($category)) {
				message('抱歉，请您先添加资源分类！', $this->createWebUrl('shopping', array('operation' => 'post','op' => 'category')), 'error');
			}
			if (checksubmit('submit')) {
...
//				}
				...
				//message('资源更新成功！', $this->createWebUrl('goods', array('op' => 'display')), 'success');
				message('资源更新成功！', referer(), 'success');
			}
