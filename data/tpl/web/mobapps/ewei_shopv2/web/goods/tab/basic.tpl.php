...
<div class="form-group">
    <label class="col-sm-2 control-label">资源短标题</label>
    <?php if( ce('goods' ,$item) ) { ?>
    <div class="col-sm-9 subtitle">
        <input type="text" name="shorttitle" class="form-control" value="<?php  echo $item['shorttitle'];?>" />
        <div class="help-block">资源短标题 用于快递打印,以及小型热敏打印机打印</div>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        <div class="help-block">资源关键字,能准确搜到资源的,比如 : 海尔电视|电视 之类的</div>
    </div>
    <?php  } else { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <label class="radio-inline"><input type="radio" name="type" value="1" <?php  if(!empty($item['id'])) { ?>disabled<?php  } ?> <?php  if(empty($item['type']) || $item['type'] == 1) { ?>checked="true"<?php  } ?> onclick="type_change(1);" /> 实体资源</label>
        <label class="radio-inline"><input type="radio" name="type" value="2" <?php  if(!empty($item['id'])) { ?>disabled<?php  } ?>  <?php  if($item['type'] == 2) { ?>checked="true"<?php  } ?>  onclick="type_change(2);" /> 虚拟资源</label>
        ...
        <span class="help-block">资源类型，资源保存后无法修改，请谨慎选择</span>
...
<div class="col-sm-6 col-xs-6">
    ...
    <span>提示：直接选中虚拟物品模板即可，选择多规格需在资源规格页面设置</span>
    <?php  } else { ?>
    <?php  if(is_array($virtual_types)) { foreach($virtual_types as $virtual_type) { ?>
...
<div class="form-group">
    <label class="col-sm-2 control-label">资源属性</label>
    <div class="col-sm-9 col-xs-12" >
        <?php if( ce('goods' ,$item) ) { ?>
...
<div class="form-group">
    <label class="col-sm-2 control-label">资源价格</label>
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('goods' ,$item) ) { ?>
        ...
        <span class='help-block'>尽量填写完整，有助于于资源销售的数据分析</span>
        <?php  } else { ?>
...
<div class="form-group">
	...
	<span class='help-block'>资源所在地，显示在详情页面，如果不选择，则显示商城所在地
