	...
	<section class="layout clearfix">
    	...
    	<section class="login_tab"  style="border-radius:15px; -moz-border-radius: 15px;-webkit-border-radius: 15px; ">
            ...
            <form action="" method="post" role="form" onsubmit="return formcheck();">
            	<table width="100%">
                	<tr>
                    	<td><input type="text" class="admin_icon"  id="firstname" value="admin" name="username" placeholder="输入您的账号"></td>
                    </tr>
                    <tr>
                    	<td><input type="password" class="pwd_icon" id="password" value="12222" name="password" placeholder="输入您的密码"></td>
                    </tr>
                    <tr>
