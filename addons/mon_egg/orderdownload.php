...
$tableheader = array($this->encode("资源", $dc),$this->encode("款式", $dc),$this->encode('用户openID', $dc),$this->encode( "订单编号", $dc),
	$this->encode( "微信支付单号", $dc),$this->encode("收货人", $dc),$this->encode("电话", $dc), $this->encode("邮编", $dc),$this->encode("收货地址", $dc),$this->encode("资源原价", $dc),
