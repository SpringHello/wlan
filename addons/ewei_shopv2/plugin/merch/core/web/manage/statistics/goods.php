...
class Goods_EweiShopV2Page extends MerchWebPage
{
	public function main()
	{
		...
		if ($_GPC['export'] == 1) {
			...
			$list[] = array('data' => '资源总计', 'count' => $total);
