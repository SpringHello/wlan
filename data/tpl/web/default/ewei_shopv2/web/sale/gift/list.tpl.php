...
<tr>
    ...
    <td  style="overflow:visible;position:relative;text-align: right;">
        ...
        <a  class='btn btn-default btn-sm' data-toggle='ajaxRemove' href="<?php  echo webUrl('sale/gift/delete1', array('id' => $item['id']))?>" data-confirm='如果此活动存在购买记录，会无法关联到资源, 确认要彻底删除吗?？'><i class='fa fa-remove'></i> 彻底删除</a>
        <?php  } ?>
    </td>
</tr>
<tr>
