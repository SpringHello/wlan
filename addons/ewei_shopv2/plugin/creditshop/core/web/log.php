...
class Log_EweiShopV2Page extends PluginWebPage 
{
	...
	public function detail() 
	{
		...
		if (empty($goods['id'])) 
		{
			$this->message('资源记录不存在!', referer(), 'error');
		}
		$set = m('common')->getPluginset('creditshop');
		$canexchange = true;
		if ($log['status'] == 2) 
