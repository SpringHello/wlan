<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group" id='goodsdiv' <?php  if(empty($goods)) { ?>style="display:none"<?php  } ?>>
                  ...
                  <div class="col-sm-9 col-xs-12">
                          ...
                          <?php  echo tpl_selector('goodsid', array('url'=>webUrl('shop/query'), 'items'=>$goods,'placeholder'=>'请输入资源标题','buttontext'=>'选择资源'))?>
                ...
                <td style='width:320px;padding:10px;' valign='top'>
                    <div id='poster'>
                        ...
                        <img src='<?php  echo tomedia($item['bg'])?>' class='bg'/>
                            ...
                            <div class=text style="font-size:<?php  echo $d['size'];?>;color:<?php  echo $d['color'];?>">资源名称</div> 
                            <?php  } else if($d['type']=='marketprice') { ?>
                            <div class=text style="font-size:<?php  echo $d['size'];?>;color:<?php  echo $d['color'];?>">资源现价</div> 
                            <?php  } else if($d['type']=='productprice') { ?>
                            <div class=text style="font-size:<?php  echo $d['size'];?>;color:<?php  echo $d['color'];?>">资源原价</div> 
                            <?php  } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-xs-12">
                                    ...
                                    <span id="goodsparams" <?php  if($item['type']!=3) { ?>style="display:none"<?php  } ?>>
                                          <br />
                                        <button class='btn btn-default btn-com' type='button' data-type='title' >资源名称</button>    
                                        <button class='btn btn-default btn-com' type='button' data-type='thumb' >资源图片</button>    
                                        <button class='btn btn-default btn-com' type='button' data-type='marketprice' >资源现价</button>    
                                        <button class='btn btn-default btn-com' type='button' data-type='productprice' >资源原价</button>    
                                    </span>
                                </div>
                            </div>
